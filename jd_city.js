...
let inviteCodes = [
  'RtGKze-lQA-kKoGSRIYw1xUjt_yOMWb4q6czBK4-sfPD9qerxA','W9Gbt6X-JWrwFPDtUqxImg0295oKsbPNSnvEgPAEJf3ov5lh','yTJcHUMalI0hqCQKwGyy05topt0Exz0YmsND55_-EOtRy0mKh54L'
]
$.shareCodesArr = [];
!(async () => {
  if (!cookiesArr[0]) {
